...
{
	auto selectedRule{ nameRules[Data::getInstance().random2() % nameRules.size()] };
...
void NameGenerator::readMap(std::string path, std::map<std::string, std::vector<std::string>>& map)
{
