...
std::shared_ptr<Scenario::Hoi4::Region> getRandomCoastalRegion(
    const std::shared_ptr<Scenario::Hoi4::Hoi4Country> &country) {
  std::vector<std::shared_ptr<Scenario::Hoi4::Region>> coastalRegions;
...
Scenario::Hoi4::Selectors::getOpposingIdeologyNeighboursNeighbours(
  ...
  return std::vector<std::shared_ptr<Scenario::Hoi4::Hoi4Country>>(
