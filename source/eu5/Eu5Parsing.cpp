...
//                 const std::vector<std::shared_ptr<Arda::ArdaProvince>>
//                 &provinces) {
...
//                                   std::to_string(packedHeightmap.height() -
//                                   5));
//   pU::writeFile(path, content);
// }
//
...
//     }
//
//     Rpx::Parsing::replaceOccurences(statePops, "templatePopList",
//     listOfPops); listOfStates.append(statePops);
//   }
//   Rpx::Parsing::replaceOccurences(popsFile, "templatePopsData",
//   listOfStates);
//
...
//   history"); auto file = pU::readFile(Fwg::Cfg::Values().resourcePath +
...
//     const std::string &path,
//     const std::map<std::string, std::shared_ptr<Country>> &countries) {
//   Fwg::Utils::Logging::logLine("Vic3 Parser: Common: Writing country
//   history"); const auto countryTemplate =
//       pU::readFile(Fwg::Cfg::Values().resourcePath +
...
//     const std::vector<std::shared_ptr<Arda::Culture>> &cultures,
//     const std::vector<std::shared_ptr<Arda::Religion>> &religions) {
//   Fwg::Utils::Logging::logLine("Vic3 Parser: Common: Writing static
//   modifiers"); const auto cultureTemplateFile = pU::readFile(
...
//     Rpx::Parsing::replaceOccurences(content, "templateCulture",
//     culture->name); cultureContent.append(content);
//   }
//   pU::writeFile(path + "//07_culture_standard_of_living.txt",
//   cultureContent);
...
//   }
//   pU::writeFile(path + "//08_religion_standard_of_living.txt",
//   religionContent);
// }
...
//   /* Until figured out why farm locators close to the coast crash the game,
//   this is removed */
//   // pU::replaceOccurence(farmContent, "templateLocators",
